...
export default function CommunityPage() {
    ...
    const handleCreatePost = () => {
        ...
        navigate('/create', { state: { communityName } });
    };
        ...
        <div className="community-page">
            ...
            <div className="community-container">
                ...
                <div className="community-main">
                    ...
                    {loading ? (
                        <div style={{ padding: '20px', textAlign: 'center', color: 'var(--text-secondary)' }}>Loading posts...</div>
                    ) : posts.length > 0 ? (
                        posts.map(post => (
                            <PostCard
                                key={post.id}
                        ...
                        <div style={{
                            ...
                            <h3 style={{ color: 'var(--text-primary)' }}>There are no posts here yet</h3>
                            <p style={{ color: 'var(--text-secondary)', marginBottom: '20px' }}>Be the first to create a post in r/{communityName}</p>
                ...
                <div className="community-sidebar">
                        ...
                        <div className="card-content">
                            ...
                            <div className="community-stats">
                                <div className="stat-item">
                                    <span className="stat-count">{memberCount !== null ? memberCount.toLocaleString() : communityData.members}</span>
                    ...
                    <div className="community-card">
                        ...
                        <div className="card-content rules-list">
                            ...
                            <div className="rule-item" style={{ cursor: 'pointer', color: 'var(--primary)' }}>See more</div>
                        </div>
                    </div>
                </div>
            </div>
